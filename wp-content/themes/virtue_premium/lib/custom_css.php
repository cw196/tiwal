...
if(!empty($virtue_premium['primary_color'])) {
  $primaryrgb = hex2rgb($virtue_premium['primary_color']); 
  ...
  .nav-trigger-case:hover .kad-navbtn, #kadbreadcrumbs a:hover, #wp-calendar a, .testimonialbox .kadtestimoniallink:hover {color: '.$virtue_premium['primary_color'].';}
...
.widget_layered_nav ul li.chosen a:hover, .shop_table .actions input[type=submit].checkout-button:hover, .order-actions .button:hover, input[type="submit"].button:hover, .product_item.hidetheaction:hover .kad_add_to_cart, .post-password-form input[type="submit"]:hover {background: '.$virtue_premium['primary20_color'].';}';
} else {
  $color_primary30 = '';
}
if(!empty($virtue_premium['gray_font_color'])) {
  $color_grayfont = '.color_gray, #kadbreadcrumbs a, .subhead, .subhead a, .posttags, .posttags a, .product_meta a {color:'.$virtue_premium['gray_font_color'].';}';
} else {
  $color_grayfont = '';
}
...
$boxedbg_repeat = $virtue_premium['boxed_bg_repeat'];
} else {
  $boxedbg_repeat = '';
}
...
$boxedbg_fixed = $virtue_premium['boxed_bg_fixed']; 
} else {
  $boxedbg_fixed = '';
}
...
if (isset($virtue_premium['dropdown_background_color']) ) {
...
if (isset($virtue_premium['dropdown_font_color']) ) {
  $mdropdown_font = '#nav-main ul.sf-menu ul li a, .nav-main ul.sf-menu ul li a, #nav-second ul.sf-menu ul li a, .topbarmenu ul.sf-menu ul li a {color: '.$virtue_premium['dropdown_font_color'].';}';
} else {
  $mdropdown_font = '';
}
if (isset($virtue_premium['dropdown_border_color']) ) {
...
$kad_custom_css = '<style type="text/css">'.$logo_padding_top.$logo_padding_bottom.$logo_padding_left.$logo_padding_right.$menu_margin_top.$menu_margin_bottom.$font_family.$color_iconmenubg.$color_iconmenu.$color_primary30.$color_grayfont.$color_footerfont
.$color_primary.$color_smenu_hover.$color_smenu_bg_hover.$color_mmenu_hover.$color_pmenu_hover.$color_pmenu_bg_hover.$color_mmenu_bg_hover.$contentclass.$topbarclass.$headerclass.$menuclass.$featureclass.$mobileclass.$footerclass.$boxedclass.$logolayoutwidget
.$portfoliobread.$shopordering.$ptitle_uppercase.$x2logo.$ptitle_minheight.$smenu_width.$animate.$topbar_layout.$mdropdown_background.$mdropdown_font.$mdropdown_border.$scrolling_background.$centermenuwidthoutput.$show_author.$show_postedin.$show_comment.$stickymobile.$page_max_width.$show_date.$wp_image_border.$menu_layout_center.$mobilebtn.$custom_css.'</style>';
