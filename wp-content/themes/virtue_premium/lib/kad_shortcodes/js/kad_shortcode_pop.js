...
jQuery(document).ready(function($){
	...
	$('body').on('click','.virtue-generator-button',function(){
	...
	$('#kad-shortcode-insert').click(function(){
		...
		function kadreset_shortcodes(){
		//reset data
		$('.kadenceshortcode-content').find('input:text, input:file, textarea').val('');
		$('.kadenceshortcode-content').find('select').removeAttr("selected", " ");
		$('.kadenceshortcode-content').find('input:radio, input:checkbox').removeAttr('checked').removeAttr('selected');
		$('.kadenceshortcode-content').find('.wp-color-result').attr('style','');
	}
