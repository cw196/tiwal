...
?>
    ...
    <div id="content" class="container">
      ...
      <div class="main <?php echo kadence_main_class();?> <?php echo $postclass .' '. $fullclass; ?>" id="ktmain" role="main">
      	<?php get_template_part('templates/content', 'page'); ?>
      		<?php  global $post, $virtue_premium; $blog_category = get_post_meta( $post->ID, '_kad_blog_cat', true ); 
