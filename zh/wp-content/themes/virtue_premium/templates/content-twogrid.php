            ...
            if(empty($postsummery) || $postsummery == 'default') {
                  if(!empty($virtue_premium['post_summery_default'])) {
                        ...
                        if($postsummery == 'img_landscape') { ?>
                          <div id="post-<?php the_ID(); ?>" class="blog_item kt_item_fade_in grid_item">
                      ...
                      <?php } elseif($postsummery == 'img_portrait') { ?>
                          <div id="post-<?php the_ID(); ?>" class="blog_item grid_item kt_item_fade_in portrait-grid">
                            <div class="rowtight">
                            <?php if (has_post_thumbnail( $post->ID ) ) {
                            $image_url = wp_get_attachment_image_src( 
                            get_post_thumbnail_id( $post->ID ), 'full' ); 
                    ...
                    <?php } elseif($postsummery == 'slider_portrait') { ?>
                          <div id="post-<?php the_ID(); ?>" class="blog_item kt_item_fade_in grid_item portrait-grid">
                            <div class="rowtight">
