 ...
 */
global $virtue_premium; if(isset($virtue_premium['google_analytics'])) { $g_analytics = $virtue_premium['google_analytics'];} else {$g_analytics = '';}
...
function kadence_seo_switch() {
  global $virtue_premium;
   if(isset($virtue_premium['seo_switch'])) {
    if($virtue_premium['seo_switch'] == 1 ) {$useseo = true;} else { $useseo = false;}
} else {$useseo = true;}
  return $useseo;
  }
/**
...
function kadence_display_sidebar() {
   if (class_exists('woocommerce'))  {
        ...
        array('page-fullwidth.php','page-feature.php','page-portfolio.php','page-staff-grid.php','page-testimonial-grid.php','page-contact.php', 'page-portfolio-category.php')
      );
  } else {
  $sidebar_config = new Kadence_Sidebar(
  ...
  if( is_product()) {
    ...
    $postsidebar = get_post_meta( $post->ID, '_kad_post_sidebar', true );
      if(isset($postsidebar) && $postsidebar == 'yes') {
        ...
        global $virtue_premium; if(isset($virtue_premium['product_sidebar_default']) && $virtue_premium['product_sidebar_default'] == 'yes') {
            return false;
          } else  {
            return true;
          }
